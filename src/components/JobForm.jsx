...
import { JOB_TYPES, SALARY_RANGES } from '../constants/jobs';

const JobForm = ({ initialValues = {}, onSubmit, submitLabel = 'Submit' }) => {
  ...
  const [companyName, setCompanyName] = useState(initialValues.company?.name || '');
  const [companyDescription, setCompanyDescription] = useState(initialValues.company?.description || '');
  const [contactEmail, setContactEmail] = useState(initialValues.company?.contactEmail || '');
  const [contactPhone, setContactPhone] = useState(initialValues.company?.contactPhone || '');
      ...
      <div className="container m-auto max-w-2xl py-24">
        <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
          <form onSubmit={handleSubmit}>
            <h2 className="text-3xl text-center font-semibold mb-6">{submitLabel}</h2>
